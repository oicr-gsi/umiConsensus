...
workflow umiConsensus {
  ...
  if (reference == "hg19") {
      ...
      String hg19alignModules = "consensus-cruncher/5.0.1 data-hg19-consensus-cruncher/1.0 bwa-mem2/2.2.1 hg19-bwamem2-index/2.2.1 samtools/1.9"
      ...
      String hg19consensusModules = "consensus-cruncher/5.0.1 data-hg19-consensus-cruncher/1.0 bwa-mem2/2.2.1 hg19-bwamem2-index/2.2.1 samtools/1.9" 
